 ...
 */
package ejemplojframeconpaneldibujo;
 ...
 */
public class EjemploJFrameConPanelDibujo extends JFrame implements ItemListener {
    ...
    public EjemploJFrameConPanelDibujo() {
    ...
    public static void main(String[] args) {
        EjemploJFrameConPanelDibujo miVentana = new EjemploJFrameConPanelDibujo();
